...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white selection:bg-blue-500/30 font-sans overflow-x-hidden">
      ...
      {activePage !== 'project-health-kiosk' && (
        <Navbar activePage={activePage} setActivePage={setActivePage} />
      )}
      
      <main className="relative z-10 w-full">
        {activePage === 'home'               && <Home onNavigate={setActivePage} />}
        {activePage === 'projects'           && <Projects onNavigate={setActivePage} />}
        {activePage === 'about'              && <About />}
        {activePage === 'contact'            && <Contact />}
        {activePage === 'project-health-kiosk' && <HealthKioskProject onNavigate={setActivePage} />} {/* ← ADD THIS */}
      </main>
